  ...
  return (
    <nav style={{ boxShadow: navShadow ? '0 1px 0 #e5e7eb' : 'none', background: '#ffffff', borderBottom: '1px solid #e5e7eb' }}>
      <Link href="/" className="nav-logo" style={{ display: 'inline-flex', alignItems: 'center', gap: 8, textDecoration: 'none' }}>
        ...
        <span className="nav-logo-text" style={{ fontFamily: "var(--font-barlow-condensed), 'Barlow Condensed', sans-serif", fontWeight: 800, fontSize: 'clamp(14px, 2vw, 20px)', letterSpacing: '0.06em', textTransform: 'uppercase', lineHeight: 1 }}>
