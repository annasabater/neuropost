...
const DEMO_INTERACTIONS: Interaction[] = [
  ...
  { id: 'i2', type: 'comment', platform: 'instagram', authorId: 'u2', authorName: 'Carlos López', text: 'Llevo esperando el pedido 2 semanas y nadie me responde. Muy mal servicio.', timestamp: new Date(Date.now() - 7200000).toISOString() },
  ...
  { id: 'i5', type: 'comment', platform: 'instagram', authorId: 'u5', authorName: 'Lucía Sanz',   text: 'Pregunta: ¿tenéis opción vegetariana en el menú del mediodía?', timestamp: new Date(Date.now() - 18000000).toISOString() },
];
