...
export async function POST(req: NextRequest) {
  try {
    ...
    if (error) throw error;
    void logWorkerAction(worker.id, worker.display_name ?? '', 'create', 'fixed_cost',
...
export async function PATCH(req: NextRequest) {
  try {
    ...
    if (error) throw error;
    void logWorkerAction(worker.id, worker.display_name ?? '', 'update', 'fixed_cost',
...
export async function DELETE(req: NextRequest) {
  try {
    ...
    if (error) throw error;
    void logWorkerAction(worker.id, worker.display_name ?? '', 'delete', 'fixed_cost',
