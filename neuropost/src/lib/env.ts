...
const REQUIRED: Record<string, string> = {
  ...
  STRIPE_PRICE_STARTER:          'Stripe price ID for Starter plan (monthly)',
  STRIPE_PRICE_PRO:              'Stripe price ID for Pro plan (monthly)',
  STRIPE_PRICE_TOTAL:            'Stripe price ID for Total plan (monthly)',
  STRIPE_PRICE_STARTER_ANNUAL:   'Stripe price ID for Starter plan (annual)',
  STRIPE_PRICE_PRO_ANNUAL:       'Stripe price ID for Pro plan (annual)',
  STRIPE_PRICE_TOTAL_ANNUAL:     'Stripe price ID for Total plan (annual)',
